              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button
                      onClick={() => handleAddToCart(salad.id)}
                      className={`btn-premium text-xs !px-5 !py-2.5 ${addedToCart[salad.id] ? "!bg-lime-600" : ""}`}
                      style={!addedToCart[salad.id] ? { background: "linear-gradient(135deg, #84cc16, #22c55e)" } : undefined}
                    >
                      {addedToCart[salad.id] ? "✓ Added!" : "Add to Cart"}
                    </button>
                  </div>
                </motion.div>
              );

                ...
                >
                  ...
                  <div className="flex items-start gap-4 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-bold text-white mb-0.5">{ic.name}</h3>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button
                      onClick={() => handleAddToCart(ic.id)}
                      className={`btn-premium text-xs !px-5 !py-2.5 ${addedToCart[ic.id] ? "!bg-pink-600" : ""}`}
                      style={!addedToCart[ic.id] ? { background: "linear-gradient(135deg, #ec4899, #8b5cf6)" } : undefined}
                    >
                      {addedToCart[ic.id] ? "✓ Added!" : "Add to Cart"}
                    </button>
                  </div>
                </motion.div>
              );
